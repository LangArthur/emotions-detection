...
def main():
    parser = argparse.ArgumentParser(description="Run emotion detection on stream of image. Different input can be taken.")
    # add flag gestion
    parser.add_argument("-s", "--screen", help="use the screen as input.", action="store_true")
    parser.add_argument("-f", "--file", help="Specify a file as input.", type=str, default="")
